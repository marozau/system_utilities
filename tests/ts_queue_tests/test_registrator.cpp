...
*/
	master_test_suite.add( BOOST_TEST_CASE( &wincq_queue_constructor_tests ) );
	master_test_suite.add( BOOST_TEST_CASE( &wincq_queue_different_threads_tests ) );
	master_test_suite.add( BOOST_TEST_CASE( &wincq_queue_wait_pop_tests ) );
	...
	master_test_suite.add( BOOST_TEST_CASE( &wincq_queue_many_threads_tests ) );
